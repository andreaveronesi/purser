...
export const en = {
  ...
  'deploy.state.planned': 'Planned — not yet rolling out',
  'deploy.state.rebalancing': 'Rebalancing — redistributing layers',
  'deploy.state.stopping': 'Stopping — tearing down',
  'deploy.state.stopped': 'Stopped — no longer serving',
  'deploy.state.failed': 'Failed — rollout did not complete',
  ...
  'planner.whatIf.result.withSimulated': 'With simulated nodes',
  'planner.whatIf.result.currentFleet': 'Current fleet (no simulation)',
  'planner.whatIf.result.noImprovement': 'The simulated virtual nodes do not improve feasibility compared to the current fleet.',
  ...
  'auth.login.local.title': 'Sign in',
  'auth.login.local.username': 'Username',
  'auth.login.local.password': 'Password',
  'auth.login.local.submit': 'Sign in',
  'auth.login.local.error': 'Invalid credentials. Please try again.',
